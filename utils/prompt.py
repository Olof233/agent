...
gen_prompt = """Create a comprehensive business proposal using AI for our clients, ensuring the content extends beyond 2000 words. Make sure each section is clear and concise, while addressing all points specified. The proposal should address the following sections: 
            ...
            The proposal should be tailored to the client’s industry, highlighting relevant AI opportunities. Make sure you reply in Chinese."""